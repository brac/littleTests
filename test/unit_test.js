...
const { concatStrings } = require('../public/javascripts/bitEngine.js')

describe('Unit Tests for functions in public/javascripts/bitEngine.js', function() {
  context('concatString', function() {
